<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            Importar Libro de Remuneraciones
        </h2>
    </x-slot>
    ...
    <div class="py-8">
        <div class="max-w-xl mx-auto sm:px-6 lg:px-8">
            ...
            <form method="POST" action="{{ route('remuneraciones.importar.subir', $empresa) }}"
                ...
                <div>
                    ...
                    <p class="text-xs text-gray-400 mt-1">
                        Columnas: nro, rut, nombre, sueldo, gratificacion, movilizacion, colacion,
