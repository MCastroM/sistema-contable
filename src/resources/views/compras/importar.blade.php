<x-app-layout>
    ...
    <div class="py-8">
        <div class="max-w-xl mx-auto sm:px-6 lg:px-8">
            ...
            <form method="POST" action="{{ route('compras.importar.previsualizar', $empresa) }}"
                ...
                <div>
                    ...
                    <p class="text-xs text-gray-400 mt-1">
                        Columnas esperadas: nro, tipo, rut, razon_social, folio, fecha, exento, neto, iva, total
                    </p>
                </div>
